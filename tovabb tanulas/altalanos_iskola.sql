...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 10. 10:34
...
CREATE TABLE `altalanos_iskola` (
  ...
  `altalanos_iskola_neve` varchar(255) COLLATE utf8mb4_hungarian_ci NOT NULL,
  `altalanos_iskola_cime` varchar(255) COLLATE utf8mb4_hungarian_ci NOT NULL
...
(3, 'Napsugár Általános Iskola ', 'Gyöngyvirág u. 4.'),
(4, 'Tóparti Általános Iskola', 'Strand út. 23.');
